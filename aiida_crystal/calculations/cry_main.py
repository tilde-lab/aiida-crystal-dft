...
BasisSetData = DataFactory('crystal.basisset')
StructSettingsData = DataFactory('crystal.structsettings')
...
class CryMainCalculation(JobCalculation):
    ...
    def _create_input_files(self, basissets, instruct, parameters,
        ...
        gui_content = crystal_gui_string(struct_dict, settings_dict)
