...
from ..calculations.cry_main import CryMainCalculation
from ..parsers.migrate import create_inputs
...
class CryMainImmigrantCalculation(CryMainCalculation):
    ...
    This is a sublass of aiida_crystal.calculations.cry_main.CryMainCalculation
