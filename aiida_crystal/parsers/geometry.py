...
def crystal_gui_string(structdata, symmdata, fractional_ops=True):
    ...
    geom_str_list.append("{0} {1} {2}".format(dimensionality, origin_setting,
                                              crystal_type))
    geom_str_list.append("{0[0]:17.9E} {0[1]:17.9E} {0[2]:17.9E}".format(
...
def dict_to_structure(structdict, logger=None):
    ...
    struct = DataFactory('structure')(cell=structdict['lattice'])
