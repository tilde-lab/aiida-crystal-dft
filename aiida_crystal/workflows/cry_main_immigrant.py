...
def migrate_as_main(work_dir,
    ...
    which imitates a ``crystal.main`` calculation
    ...
    from aiida_crystal.calculations.cry_main import CryMainCalculation
    from aiida_crystal.parsers.cry_basic import CryBasicParser
